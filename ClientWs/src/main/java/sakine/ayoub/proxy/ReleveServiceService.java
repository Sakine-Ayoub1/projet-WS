 ...
 * 
 */
@WebServiceClient(name = "ReleveServiceService", targetNamespace = "http://services.ayoub.sakine/", wsdlLocation = "http://localhost:9000/ReleveWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RELEVESERVICESERVICE_QNAME = new QName("http://services.ayoub.sakine/", "ReleveServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9000/ReleveWs?wsdl");
    ...
    public ReleveWs getReleveWsPort() {
        return super.getPort(new QName("http://services.ayoub.sakine/", "ReleveWsPort"), ReleveWs.class);
    }
    ...
    public ReleveWs getReleveWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.ayoub.sakine/", "ReleveWsPort"), ReleveWs.class, features);
    }
